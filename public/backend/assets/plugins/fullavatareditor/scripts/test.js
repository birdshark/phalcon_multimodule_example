swfobject.addDomLoadEvent(function () {
    ...
    var sourceImage = $('input[name="source"]').val()||null;
	var sourcePic1Url = $.Cookie('swf1')||sourceImage;
    ...
    var _token = $('input[name="_token"]').val(),user_id = $('input[name="user_id"]').val();
    var swf1 = new fullAvatarEditor('swf1', 335, {
		id : 'swf1',
        upload_url : '/backend/upload/avatar?_token=' + _token + '&user_id=' + user_id,
		...
		avatar_sizes : '64*64',			//定义单个头像
		avatar_sizes_desc :'64*64像素',	   //头像尺寸的提示文本。
