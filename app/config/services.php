...
use Application\Common\Library\FunctionExtension;
use Phalcon\Loader;
...
$di->setShared('voltShared', function ($view) {
    ...
    $volt->getCompiler()->addExtension(new FunctionExtension());
    return $volt;
});
...
$di->setShared('modelsManager', function() {
    $modelManager = new Phalcon\Mvc\Model\Manager();
    $modelManager->registerNamespaceAlias('c', 'Application\Common\Models');
    return $modelManager;
});
